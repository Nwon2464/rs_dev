...
const KO_UI_MESSAGES = {
  ...
  "common.noOpenSlotsSelected": "개방 줄 미선택",
  ...
  "home.open.description": "조건별 일반 장비 개방 옵션 후보와 확률을 확인할 수 있습니다.",
  "home.open.action": "일반 장비 개방 옵션 보기 →",
  "home.instandard.title": "비규격 장비",
  "home.instandard.description": "비규격 장비 옵션, 비규격 개방옵션, 티어별 옵션을 탐색합니다.",
  "mode.option.title": "비규격 장비 옵션",
  "mode.option.description": "비규격 장비 옵션의 수치 범위를 확인할 수 있습니다.",
  "mode.open.title": "비규격 개방옵션",
  "mode.open.description": "변환기·개방 줄별 후보와 확률을 확인할 수 있습니다.",
  ...
  "header.open.description": "변환기별 개방 옵션 후보와 확률을 확인할 수 있습니다.",
  ...
  "open.converterProbabilityHelp": "현재 변환기·등급·개방 줄 조건에서 각 옵션이 나올 확률입니다.",
...
const JA_UI_MESSAGES: Record<UiMessageKey, string> = {
  ...
  "common.noOpenSlotsSelected": "解放スロット未選択",
  ...
  "home.open.description": "条件別に一般装備の解放オプション候補と確率を確認できます。",
  "home.open.action": "一般装備の解放オプションを見る →",
  "home.instandard.title": "非規格装備",
  "home.instandard.description": "非規格装備オプション、非規格解放オプション、ティア別オプションを検索します。",
  "mode.option.title": "非規格装備オプション",
  "mode.option.description": "非規格装備オプションの数値範囲を確認できます。",
  "mode.open.title": "非規格解放オプション",
  "mode.open.description": "変換器・解放スロット別の候補と確率を確認できます。",
  ...
  "header.open.description": "変換器別の解放オプション候補と確率を確認できます。",
  ...
  "open.converterProbabilityHelp": "現在の変換器・等級・解放スロットの条件で、各オプションが出現する確率です。",
