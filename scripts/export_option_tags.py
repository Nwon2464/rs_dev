...
def main() -> None:
    ...
    capa = parse_capa(args.capa)
    payload = build_option_tags(capa, source_tags, option_ids)
    audit = build_option_tag_audit(capa, source_tags, option_ids)
    write_option_tags(args.output, payload)
    write_option_tag_audit(args.audit_output, audit)
